...
def execute_trades(symbol, quantity):
    # get from env var 20 and 50
    ma_20 = get_moving_average(symbol, Client.KLINE_INTERVAL_1DAY, 20)
    ma_50 = get_moving_average(symbol, Client.KLINE_INTERVAL_1DAY, 50)
